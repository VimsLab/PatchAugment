...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='patchaug', help='experiment root')
...
def main(args):
    ...
    train_dataset = ModelNet40Cls(num_points = args.num_point, root = args.data_root, transforms=train_transforms)
